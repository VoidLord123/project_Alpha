...
2. action - Содержит спрайты, которые выполняют некое действие при столкновении с игроком. Спрайты этой группы не должны быть в других!!!
3. player - Группа для спрайтов игрока. Не должны быть ни в какой другой группе!!! 
